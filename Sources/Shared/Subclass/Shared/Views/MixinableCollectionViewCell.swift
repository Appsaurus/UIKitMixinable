...
open class MixinableCollectionViewCell: UICollectionViewCell, UIViewMixinable{
    
    open lazy var mixins: [LifeCycle] = self.createMixins()
    
    open func createMixins() -> [LifeCycle] {
        return DefaultMixins.collectionViewCell(self)
    }
...
open class MixinableCollectionReusableView: UICollectionReusableView, UIViewMixinable{

    open lazy var mixins: [LifeCycle] = self.createMixins()

    open func createMixins() -> [LifeCycle] {
        return DefaultMixins.view(self)
    }
